namespace :data do
  ...
  task dataset: :environment do
    ...
    reed = User.create!(first_name: 'Reed', last_name: 'Wilson', email: 'rwilson@test.com', position: 'Product Owner')
    javi = User.create!(first_name: 'Javi', last_name: 'Gonzalez', email: 'jgonzalezn@test.com', position: 'BE Dev')
